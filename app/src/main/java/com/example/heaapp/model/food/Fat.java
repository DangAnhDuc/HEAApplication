...
public class Fat extends RealmObject {

    @SerializedName("name_translations")
    @Expose
    private NameTranslations_______ nameTranslations;
    @SerializedName("unit")
    @Expose
    private String unit;
    ...
    public NameTranslations_______ getNameTranslations() {
        return nameTranslations;
    }

    public void setNameTranslations(NameTranslations_______ nameTranslations) {
