...
public class Carbohydrates extends RealmObject {

    @SerializedName("name_translations")
    @Expose
    private NameTranslations_____ nameTranslations;
    @SerializedName("unit")
    @Expose
    private String unit;
    ...
    public NameTranslations_____ getNameTranslations() {
        return nameTranslations;
    }

    public void setNameTranslations(NameTranslations_____ nameTranslations) {
